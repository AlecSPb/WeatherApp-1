...
package com.claudiofus.clock2.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.claudiofus.clock2.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.claudiofus.clock2.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.claudiofus.clock2.extra.ID";
