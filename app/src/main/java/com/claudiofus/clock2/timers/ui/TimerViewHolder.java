...
package com.claudiofus.clock2.timers.ui;
...
import com.claudiofus.clock2.dialogs.AddLabelDialog;
import com.claudiofus.clock2.dialogs.AddLabelDialogController;
import com.claudiofus.clock2.list.BaseViewHolder;
import com.claudiofus.clock2.list.OnListItemInteractionListener;
import com.claudiofus.clock2.ringtone.playback.TimerRingtoneService;
import com.claudiofus.clock2.timers.Timer;
import com.claudiofus.clock2.timers.TimerController;
import com.claudiofus.clock2.timers.data.AsyncTimersTableUpdateHandler;
import com.claudiofus.clock2.util.FragmentTagUtils;
import com.claudiofus.clock2.util.ProgressBarUtils;
...
public class TimerViewHolder extends BaseViewHolder<Timer> {
    ...
    @Bind(com.claudiofus.clock2.R.id.label) TextView mLabel;
    @Bind(com.claudiofus.clock2.R.id.duration) CountdownChronometer mChronometer;
    @Bind(com.claudiofus.clock2.R.id.seek_bar) SeekBar mSeekBar;
    @Bind(com.claudiofus.clock2.R.id.add_one_minute) TextView mAddOneMinute;
    @Bind(com.claudiofus.clock2.R.id.start_pause) ImageButton mStartPause;
    @Bind(com.claudiofus.clock2.R.id.stop) ImageButton mStop;
    @Bind(com.claudiofus.clock2.R.id.menu) ImageButton mMenuButton;
    ...
    public TimerViewHolder(ViewGroup parent, OnListItemInteractionListener<Timer> listener,
        ...
        super(parent, com.claudiofus.clock2.R.layout.item_timer, listener);
        Log.d(TAG, "New TimerViewHolder");
        mAsyncTimersTableUpdateHandler = asyncTimersTableUpdateHandler;
        mStartIcon = ContextCompat.getDrawable(getContext(), com.claudiofus.clock2.R.drawable.ic_start_24dp);
        mPauseIcon = ContextCompat.getDrawable(getContext(), com.claudiofus.clock2.R.drawable.ic_pause_24dp);
        ...
        mPopupMenu.inflate(com.claudiofus.clock2.R.menu.menu_timer_viewholder);
        mPopupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case com.claudiofus.clock2.R.id.action_delete:
    ...
    public void onBind(final Timer timer) {
        ...
        mAddLabelDialogController.tryRestoreCallback(makeTag(com.claudiofus.clock2.R.id.label));
    ...
    @OnClick(com.claudiofus.clock2.R.id.start_pause)
    void startPause() {
        mController.startPause();
    }

    @OnClick(com.claudiofus.clock2.R.id.add_one_minute)
    void addOneMinute() {
        mController.addOneMinute();
    }

    @OnClick(com.claudiofus.clock2.R.id.stop)
    void stop() {
        mController.stop();
        getContext().stopService(new Intent(getContext(), TimerRingtoneService.class));
    }

    @OnClick(com.claudiofus.clock2.R.id.label)
    void openLabelEditor() {
        mAddLabelDialogController.show(mLabel.getText(), makeTag(com.claudiofus.clock2.R.id.label));
    }

    @OnClick(com.claudiofus.clock2.R.id.menu)
    void openMenu() {
        mPopupMenu.show();
    }
