...
import com.claudiofus.clock2.timers.ui.CountdownChronometer;
...
public class TimesUpActivity extends RingtoneActivity<Timer> {
    ...
    protected void getHeaderContent(ViewGroup parent) {
        ...
        CountdownChronometer countdown = (CountdownChronometer) getLayoutInflater()
                .inflate(com.claudiofus.clock2.R.layout.content_header_timesup_activity, parent, false);
    ...
    protected int getAutoSilencedText() {
        return com.claudiofus.clock2.R.string.timer_auto_silenced_text;
    }

    @Override
    protected int getLeftButtonText() {
        return com.claudiofus.clock2.R.string.add_one_minute;
    }

    @Override
    protected int getRightButtonText() {
        return com.claudiofus.clock2.R.string.stop;
    }

    @Override
    protected int getLeftButtonDrawable() {
        return com.claudiofus.clock2.R.drawable.ic_add_48dp;
    }

    @Override
    protected int getRightButtonDrawable() {
        return com.claudiofus.clock2.R.drawable.ic_stop_48dp;
    }
    ...
    private void postExpiredTimerNote() {
        Notification note = new NotificationCompat.Builder(this)
                .setContentTitle(getString(com.claudiofus.clock2.R.string.timer_expired))
