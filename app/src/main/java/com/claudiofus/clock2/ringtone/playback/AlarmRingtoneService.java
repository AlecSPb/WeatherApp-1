...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.claudiofus.clock2.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.claudiofus.clock2.ringtone.action.DISMISS";
