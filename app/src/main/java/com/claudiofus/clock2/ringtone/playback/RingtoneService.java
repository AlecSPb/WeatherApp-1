...
import com.claudiofus.clock2.ringtone.RingtoneActivity;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "com.claudiofus.clock2.ringtone.action.NOTIFY_MISSED";
