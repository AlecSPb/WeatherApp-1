...
package com.claudiofus.clock2.settings;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.claudiofus.clock2.R.xml.preferences);

        preferences = getPreferenceScreen().getSharedPreferences();
        geolocationEnabled = (SwitchPreference) findPreference(getString(com.claudiofus.clock2.R.string.pref_geolocation_enabled_key));
        manualLocation = (EditTextPreference) findPreference(getString(com.claudiofus.clock2.R.string.pref_manual_location_key));

        bindPreferenceSummaryToValue(manualLocation);
        bindPreferenceSummaryToValue(findPreference(getString(com.claudiofus.clock2.R.string.pref_temperature_unit_key)));

        // Set ringtone summary
        setSummary(preferences, getString(com.claudiofus.clock2.R.string.key_timer_ringtone));
        findPreference(getString(com.claudiofus.clock2.R.string.key_alarm_volume))
