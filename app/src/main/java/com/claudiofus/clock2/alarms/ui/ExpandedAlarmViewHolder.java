...
package com.claudiofus.clock2.alarms.ui;
...
import com.claudiofus.clock2.dialogs.RingtonePickerDialog;
import com.claudiofus.clock2.dialogs.RingtonePickerDialogController;
import com.claudiofus.clock2.dialogs.TimePickerDialogController;
import com.claudiofus.clock2.list.OnListItemInteractionListener;
import com.claudiofus.clock2.timepickers.Utils;
import com.claudiofus.clock2.util.FragmentTagUtils;
...
public class ExpandedAlarmViewHolder extends BaseAlarmViewHolder {
    ...
    @Bind(com.claudiofus.clock2.R.id.ok) Button mOk;
    @Bind(com.claudiofus.clock2.R.id.delete) Button mDelete;
    @Bind(com.claudiofus.clock2.R.id.ringtone) Button mRingtone;
    @Bind(com.claudiofus.clock2.R.id.vibrate) TempCheckableImageButton mVibrate;
    @Bind({com.claudiofus.clock2.R.id.day0, com.claudiofus.clock2.R.id.day1, com.claudiofus.clock2.R.id.day2, com.claudiofus.clock2.R.id.day3, com.claudiofus.clock2.R.id.day4, com.claudiofus.clock2.R.id.day5, com.claudiofus.clock2.R.id.day6})
    ToggleButton[] mDays;
    @Bind({com.claudiofus.clock2.R.id.sunny, com.claudiofus.clock2.R.id.rain, com.claudiofus.clock2.R.id.cloud, com.claudiofus.clock2.R.id.snow, com.claudiofus.clock2.R.id.fog, com.claudiofus.clock2.R.id.wind})
    ToggleButton[] mWeatherCondition;
    @Bind(com.claudiofus.clock2.R.id.temperatureTextView) TextView temperature;
    @Bind(com.claudiofus.clock2.R.id.conditionTextView) TextView condition;
    @Bind(com.claudiofus.clock2.R.id.locationTextView) TextView location;
    @Bind({com.claudiofus.clock2.R.id.sunnyTime, com.claudiofus.clock2.R.id.rainTime, com.claudiofus.clock2.R.id.cloudTime, com.claudiofus.clock2.R.id.snowTime, com.claudiofus.clock2.R.id.fogTime, com.claudiofus.clock2.R.id.windTime})
    TextView[] mWeatherTime;
    @Bind(com.claudiofus.clock2.R.id.weatherConditionsTime) LinearLayout weatherConditionsTime;
    ...
    public ExpandedAlarmViewHolder(ViewGroup parent, final OnListItemInteractionListener<Alarm> listener,
        ...
        super(parent, com.claudiofus.clock2.R.layout.item_expanded_alarm, listener, controller);
...
//                listener.onListItemUpdate(getAlarm(), getAdapterPosition());
        ...
        int[] dayToggleColors = {
                /*item 1*/Utils.getTextColorFromThemeAttr(getContext(), com.claudiofus.clock2.R.attr.colorAccent),
                /*item 2*/Utils.getTextColorFromThemeAttr(getContext(), android.R.attr.textColorHint)
        };
        int[] vibrateColors = {
                /*item 1*/Utils.getTextColorFromThemeAttr(getContext(), com.claudiofus.clock2.R.attr.colorAccent),
                /*item 2*/Utils.getTextColorFromThemeAttr(getContext(), com.claudiofus.clock2.R.attr.themedIconTint)
        };
    ...
    public void onBind(Alarm alarm) {
        super.onBind(alarm);
        mRingtonePickerController.tryRestoreCallback(makeTag(com.claudiofus.clock2.R.id.ringtone));
        bindDays(alarm);
        bindRingtone();
    ...
    @OnClick(com.claudiofus.clock2.R.id.ringtone)
...
//        ((Activity) getContext()).startActivityForResult(intent, AlarmsFragment.REQUEST_PICK_RINGTONE);
        ...
        mRingtonePickerController.show(getSelectedRingtoneUri(), makeTag(com.claudiofus.clock2.R.id.ringtone));
    }

    @OnClick(com.claudiofus.clock2.R.id.vibrate)
    ...
    @OnClick({ com.claudiofus.clock2.R.id.day0, com.claudiofus.clock2.R.id.day1, com.claudiofus.clock2.R.id.day2, com.claudiofus.clock2.R.id.day3, com.claudiofus.clock2.R.id.day4, com.claudiofus.clock2.R.id.day5, com.claudiofus.clock2.R.id.day6 })
    ...
    @OnClick({com.claudiofus.clock2.R.id.sunny, com.claudiofus.clock2.R.id.rain, com.claudiofus.clock2.R.id.cloud, com.claudiofus.clock2.R.id.snow, com.claudiofus.clock2.R.id.fog, com.claudiofus.clock2.R.id.wind})
    void onWeatherCondToggled(ToggleButton view) {
        for (TextView tv : mWeatherTime){
            tv.setText(getContext().getString(com.claudiofus.clock2.R.string.not_set));
        }
        ...
        if (view.isChecked()) {
            ...
            mWeatherTime[position].setText(getContext().getString(com.claudiofus.clock2.R.string.not_set));
    ...
    private void bindRingtone() {
        int iconTint = Utils.getTextColorFromThemeAttr(getContext(), com.claudiofus.clock2.R.attr.themedIconTint);
