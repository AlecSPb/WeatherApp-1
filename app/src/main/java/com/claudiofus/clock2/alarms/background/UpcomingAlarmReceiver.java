...
package com.claudiofus.clock2.alarms.background;
...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_DISMISS_NOW = "com.claudiofus.clock2.action.DISMISS_NOW";

    public static final String ACTION_CANCEL_NOTIFICATION = "com.claudiofus.clock2.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "com.claudiofus.clock2.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.claudiofus.clock2.extra.ALARM";
