...
import com.claudiofus.clock2.alarms.data.AlarmsListCursorLoader;
import com.claudiofus.clock2.alarms.data.AsyncAlarmsTableUpdateHandler;
import com.claudiofus.clock2.alarms.misc.AlarmController;
import com.claudiofus.clock2.dialogs.TimePickerDialogController;
import com.claudiofus.clock2.list.RecyclerViewFragment;
import com.claudiofus.clock2.util.DelayedSnackbarHandler;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.claudiofus.clock2.alarms.extra.SCROLL_TO_ALARM_ID";
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mSnackbarAnchor = getActivity().findViewById(com.claudiofus.clock2.R.id.main_content);
    ...
    protected int emptyMessage() {
        return com.claudiofus.clock2.R.string.empty_alarms_container;
    }

    @Override
    protected int emptyIcon() {
        return com.claudiofus.clock2.R.drawable.ic_alarm_96dp;
    }
    ...
    private static String makeTimePickerDialogTag() {
        return FragmentTagUtils.makeTag(AlarmsFragment.class, com.claudiofus.clock2.R.id.fab);
    }
}
