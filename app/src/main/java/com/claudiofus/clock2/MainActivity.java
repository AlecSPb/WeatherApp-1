...
public class MainActivity extends BaseActivity {
    ...
    public static final String EXTRA_SHOW_PAGE = "com.claudiofus.clock2.extra.SHOW_PAGE";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Constants.setWeatherConditions(this);
